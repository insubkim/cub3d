...
/*   Updated: 2023/07/17 02:13:16 by heson            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * return: none
 */
void	do_raycasting(double **dist_of_rays, t_player player, int screen_width, int **map_board)
{
	int		x;
	t_ray_data	ray;
...
void	get_real_pixel_to_draw(int screen_height, double dist_of_ray)
{
	...
	int line_height = (int)(screen_height / dist_of_ray);
